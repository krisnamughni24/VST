...
void DelayProcessor::initialise(float param_maximum_delay_time, double DSP_sample_rate)
{
  ...
  for (int i = 0; i < OSCTABLESIZE; i++)
  {
    ...
    scrape_table[i] = 0.025 * sin(TWOPI * 2.0 * i / OSCTABLESIZE + 0.67 * TWOPI) + 0.0289 * sin(TWOPI * 3.0 * i / OSCTABLESIZE + 0.42 * TWOPI) + 0.0313 * sin(TWOPI * 4.0 * i / OSCTABLESIZE + 0.86 * TWOPI) + 0.0156 * sin(TWOPI * 5.0 * i / OSCTABLESIZE + 0.38 * TWOPI) + 0.0165 * sin(TWOPI * 6.0 * i / OSCTABLESIZE + 0.71 * TWOPI) + 0.0264 * sin(TWOPI * 7.0 * i / OSCTABLESIZE + 0.29 * TWOPI) + 0.0198 * sin(TWOPI * 8.0 * i / OSCTABLESIZE + 0.92 * TWOPI) + 0.0249 * sin(TWOPI * 9.0 * i / OSCTABLESIZE + 0.54 * TWOPI) + 0.0195 * sin(TWOPI * 10.0 * i / OSCTABLESIZE + 0.13 * TWOPI) + 0.0158 * sin(TWOPI * 11.0 * i / OSCTABLESIZE + 0.66 * TWOPI) + 0.0213 * sin(TWOPI * 12.0 * i / OSCTABLESIZE + 0.45 * TWOPI) + 0.0259 * sin(TWOPI * 13.0 * i / OSCTABLESIZE + 0.88 * TWOPI) + 0.0176 * sin(TWOPI * 14.0 * i / OSCTABLESIZE + 0.31 * TWOPI) + 0.0165 * sin(TWOPI * 15.0 * i / OSCTABLESIZE + 0.65 * TWOPI) + 0.0129 * sin(TWOPI * 16.0 * i / OSCTABLESIZE + 0.32 * TWOPI) + 0.0224 * sin(TWOPI * 17.0 * i / OSCTABLESIZE + 0.76 * TWOPI) + 0.0164 * sin(TWOPI * 18.0 * i / OSCTABLESIZE + 0.25 * TWOPI) + 0.0218 * sin(TWOPI * 19.0 * i / OSCTABLESIZE + 0.12 * TWOPI) + 0.0089 * sin(TWOPI * 20.0 * i / OSCTABLESIZE + 0.84 * TWOPI) + 0.0123 * sin(TWOPI * 21.0 * i / OSCTABLESIZE + 0.48 * TWOPI) + 0.0074 * sin(TWOPI * 22.0 * i / OSCTABLESIZE + 0.64 * TWOPI) + 0.0189 * sin(TWOPI * 23.0 * i / OSCTABLESIZE + 0.86 * TWOPI) + 0.0220 * sin(TWOPI * 24.0 * i / OSCTABLESIZE + 0.34 * TWOPI) + 0.0103 * sin(TWOPI * 25.0 * i / OSCTABLESIZE + 0.75 * TWOPI) + 0.0152 * sin(TWOPI * 26.0 * i / OSCTABLESIZE + 0.62 * TWOPI) + 0.0086 * sin(TWOPI * 27.0 * i / OSCTABLESIZE + 0.54 * TWOPI) + 0.0120 * sin(TWOPI * 28.0 * i / OSCTABLESIZE + 0.92 * TWOPI) + 0.0089 * sin(TWOPI * 29.0 * i / OSCTABLESIZE + 0.53 * TWOPI) + 0.0104 * sin(TWOPI * 30.0 * i / OSCTABLESIZE + 0.81 * TWOPI) + 0.0120 * sin(TWOPI * 31.0 * i / OSCTABLESIZE + 0.10 * TWOPI) + 0.0056 * sin(TWOPI * 32.0 * i / OSCTABLESIZE + 0.08 * TWOPI) + 0.0216 * sin(TWOPI * 1.0 * i / OSCTABLESIZE);
  }
